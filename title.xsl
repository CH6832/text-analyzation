<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:math="http://www.w3.org/2005/xpath-functions/math" exclude-result-prefixes="xs math" version="3.0">
    ...
    <html>
        <head>
            <title>Titel</title>
            <link href="/exist/rest/briefe/css/bootstrap.min.css" rel="stylesheet"/>
        <link href="/exist/rest/briefe/css/starter-template.css" rel="stylesheet"/>
        </head>
        <body>
    ...
    <!-- Bootstrap Navigation -->
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link" href="/exist/rest/briefe/index.xquery">Home
                                </a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="/exist/rest/briefe/listing.xquery">Textsammlung
                                </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/exist/rest/briefe/analyze-all.xquery">Analyse</a>
          </li>
        </ul>
      </div>
    </nav>
